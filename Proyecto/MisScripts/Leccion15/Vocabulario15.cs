...
public class Vocabulario15 : MonoBehaviour
{
	GameObject Texto1, Texto2, Texto3,Texto4,Texto5,Texto6,Texto7,Texto8,Texto9,Texto10,Texto11,
	Play, Next,Anterior,Escuchar, Dialogo, Ejercicios, Exit,Lecciones,samba;
	...
	void Update(){
		...
		if(!samba.GetComponent<Animation>().isPlaying){
			samba.GetComponent<Animation>().Play();
		}
