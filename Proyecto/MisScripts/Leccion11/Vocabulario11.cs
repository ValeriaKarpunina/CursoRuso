...
public class Vocabulario11 : MonoBehaviour
{
	GameObject Texto1, Texto2, Texto3,Texto4,Texto5,Texto6,Texto7,Texto8,Texto9,Texto10,Texto11,
	Play, Next,Anterior,Escuchar, Dialogo, Ejercicios, Exit,Lecciones,model3,model4,model11,model8,model9;
	...
	void Start () {
		...
		model4=GameObject.Find("model4");
		model8=GameObject.Find("model8");
		model9=GameObject.Find("model9");
		model11=GameObject.Find("model11");
		ninia=model8.GetComponent<Animation>();
		...
		if (Input.touchCount > 0)
		{
			...
			if (Physics.Raycast(ray, out hit))
			{
					...
					if (theTouch.phase == TouchPhase.Began)
					{
						...
						case "Escuchar":
							Application.LoadLevel("Escuchar11");
