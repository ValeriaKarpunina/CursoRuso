...
public class Dialogo17 : MonoBehaviour
{
	Animation animation1;
	GameObject texto, texto2,Play, Play2, Pausa, Pausa2, Repeat, traduccion,traduccion2,Vocabulario, 
	Escuchar, Ejercicios, Exit,Lecciones, Anna,Boy, Brazo,Tronco;
				...
				if (theTouch.phase == TouchPhase.Began)
				{
					...
					case "Play":
						...
						if(!repeticion){
							...
							source.Play();
							Boy.GetComponent<Animation>().Play();
							primero=1;
					...
					case "Play2":
						if(!repeticion){
							...
							Anna.GetComponent<Animation>().Play();
							segundo=1;
						}
