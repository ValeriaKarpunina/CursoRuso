...
public class Escuchar17 : MonoBehaviour
{
	GameObject texto1, texto2, texto3,texto4,texto5,texto6,texto7,texto8,
	Play, Pause, Next, Repeat, Anterior, Vocabulario, Dialogo, Ejercicios, Exit,Lecciones,Model,PlayGlobal,Vpered,Nazad,PausaGlobal;
