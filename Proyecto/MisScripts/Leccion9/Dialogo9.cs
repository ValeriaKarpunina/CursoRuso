...
public class Dialogo9 : MonoBehaviour
{
	...
	//en la ultima frase, falta meterle el contador de frases y cuando llegue a la ultima que no se reanude
	//el audio al pulsar next
}
