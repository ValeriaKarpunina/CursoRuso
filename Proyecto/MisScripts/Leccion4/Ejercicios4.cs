...
public class Ejercicios4 : MonoBehaviour
{
	...
	int i,j,m;
	int puntuacion;
	GameObject modelo2,modelo1,opcion1, opcion2, opcion1_2,opcion1_3,opcion2_2,opcion2_3, SCORE, Correcto, Incorrecto,
	...
	void Start(){
		...
		opcion2_3=GameObject.Find("opcion2_3");
	...
	void Update(){
			...
			if (Physics.Raycast(ray, out hit))
			{
					if (theTouch.phase == TouchPhase.Began)
					{
						...
						case "opcion1_3":
							Correcto.SetActive(false);
							Incorrecto.SetActive(true);
							opcion1_3.GetComponent<TextMesh>().color = Color.gray;
							intentos=intentos-1;
						...
						case "opcion2_3":
							...
							opcion2_3.GetComponent<TextMesh>().color = Color.gray;
							correcto=true;
							j=1;
							break;
						case "opcion2_2":
		...
		if(!saveActivo){
			...
			if(intentos==0){
				if(!repetido){
					SaveLoad save=new SaveLoad(65,3,0);
					save.Save();
				}
