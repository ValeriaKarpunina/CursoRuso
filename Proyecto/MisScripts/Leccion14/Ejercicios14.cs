...
public class Ejercicios14 : MonoBehaviour
{
	...
	int i;
	int puntuacion;
	GameObject palabra1,palabra2,palabra3,palabra4,eleccion1,eleccion2,eleccion3,eleccion4, eleccion1_2,eleccion2_2,eleccion3_2,eleccion4_2,
	eleccion1_3,eleccion2_3,eleccion3_3,eleccion4_3,eleccion1_4,eleccion2_4,eleccion3_4,eleccion4_4,SCORE, Correcto, Incorrecto,
	...
	void Start(){
		...
		eleccion4_3=GameObject.Find("eleccion4_3");
		eleccion1_4=GameObject.Find("eleccion1_4");
		eleccion2_4=GameObject.Find("eleccion2_4");
		eleccion3_4=GameObject.Find("eleccion3_4");
		eleccion4_4=GameObject.Find("eleccion4_4");
		...
		eleccion4_3.SetActive(false);
		eleccion1_4.SetActive(false);
		eleccion2_4.SetActive(false);
		eleccion3_4.SetActive(false);
		eleccion4_4.SetActive(false);
		...
		else if(puntuacion==350){
			i=2;
			reloj=valores[2];
			intentos=valores[1];
		}
		else if(puntuacion==355){
			i=3;
			reloj=valores[2];
			intentos=valores[1];
		}
		else if(puntuacion==360){
			i=4;
			reloj=valores[2];
			intentos=valores[1];
		}
	...
	void Update(){
		...
		if (Input.touchCount > 0)
		{
			...
			if (Physics.Raycast(ray, out hit))
			{
				if (theTouch.phase == TouchPhase.Began)
				{
					...
					case "eleccion4_3":
						eleccion4_3.GetComponent<TextMesh>().color = Color.gray;
						correcto=true;
					...
					case "eleccion1_4":
						...
						eleccion1_4.GetComponent<TextMesh>().color = Color.gray;
						correcto=true;
					...
					case "eleccion2_4":
						...
						eleccion2_4.GetComponent<TextMesh>().color = Color.gray;
						Correcto.SetActive(false);
						Incorrecto.SetActive(true);
						intentos=intentos-1;
					...
					case "eleccion3_4":
						...
						eleccion3_4.GetComponent<TextMesh>().color = Color.gray;
						Correcto.SetActive(false);
						Incorrecto.SetActive(true);
						intentos=intentos-1;
					...
					case "eleccion4_4":
						...
						eleccion4_4.GetComponent<TextMesh>().color = Color.gray;
						Correcto.SetActive(false);
						Incorrecto.SetActive(true);
						intentos=intentos-1;
					...
					case "reintentar":
						...
						if(i==4){
							...
							eleccion3_3.SetActive(false);
							eleccion4_3.SetActive(false);
							eleccion1_4.SetActive(true);
							eleccion2_4.SetActive(true);
							eleccion3_4.SetActive(true);
							eleccion4_4.SetActive(true);
							tiempo=10;
						}
				...
				if (theTouch.phase == TouchPhase.Ended)
				{
					...
					eleccion4_3.GetComponent<TextMesh>().color=Color.yellow;
					eleccion1_4.GetComponent<TextMesh>().color=Color.yellow;
					eleccion2_4.GetComponent<TextMesh>().color=Color.yellow;
					eleccion3_4.GetComponent<TextMesh>().color=Color.yellow;
					eleccion4_4.GetComponent<TextMesh>().color=Color.yellow;
				}
			}
		}
		...
		if(!saveActivo){
			...
			if(intentos==0){
				if(!repetido){
					SaveLoad save=new SaveLoad(345,3,0);
					save.Save();
				}
		...
		if(correcto){
			...
			if(i==4){
				...
				SCORE.GetComponent<TextMesh>().text = puntuacion.ToString();
				if(!repetido){
					SaveLoad save=new SaveLoad(puntuacion,intentos,Mathf.RoundToInt(reloj),14,Mathf.RoundToInt(reloj));
					save.Save();
				}
				correcto=false;
