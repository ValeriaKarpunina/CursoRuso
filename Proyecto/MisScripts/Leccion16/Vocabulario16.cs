...
public class Vocabulario16 : MonoBehaviour
{
	GameObject Texto, Texto2, Texto3,Texto4,Texto5,Texto6,Texto7,Texto8,Texto9,z,z1,z2,z3,z4,z5,z6,z7,z8,
	Play, Next,Anterior,Escuchar, Dialogo, Ejercicios, Exit,Lecciones,Model,Model2,Model3;
		...
		if (Input.touchCount > 0)
		{
			...
			if (Physics.Raycast(ray, out hit))
			{
					...
					if (theTouch.phase == TouchPhase.Began)
					{
						...
						case "Escuchar":
							Application.LoadLevel("Escuchar16");
						...
						case "Lecciones":
							Application.LoadLevel("Lecciones16");
